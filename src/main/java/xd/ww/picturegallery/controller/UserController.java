...
import xd.ww.picturegallery.model.dto.user.*;
...
import static xd.ww.picturegallery.service.impl.UserServiceImpl.SALT;
...
public class UserController {
     ...
     * 更新用户
     *
     * @param userUpdateRequest 更新用户的请求
     * @param request HttpRequest
     * @return 更新是否成功
     */
    @PostMapping("/update")
     ...
     * 分页获取用户列表（仅管理员）
     *
     * @param userQueryRequest 用户查询的请求
     * @param request HttpRequest
     * @return 返回用户列表
     */
     ...
     * 更新个人信息
     *
     * @param userUpdateMyRequest 更新个人信息的请求
     * @param request HttpRequest
     * @return 更新是否成功
     */
