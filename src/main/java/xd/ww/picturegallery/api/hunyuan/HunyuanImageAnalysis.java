...
public class HunyuanImageAnalysis {
    ...
    private String buildAnalysisPrompt() {
        return "你是一个专业的图片内容分析师，负责为图库网站生成图片的简介、标签和分类。\n\n" +
                ...
                "1.  简介（description）: 用一段流畅、简洁、有吸引力的中文描述图片内容，长度在10-20字之间。描述应涵盖主要物体、场景、氛围和色彩，不要出现标点符号。\n" +
                "2.  标签（tags）: 从以下固定标签种选出2-3个贴切的：[热门, 搞笑, 生活, 高清, 艺术, 校园, 背景, 网络, 创意]，用英文逗号\",\"分隔。如果都不匹配，请输出\"其他\"\n" +
